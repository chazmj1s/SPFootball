...
namespace SaturdayPulse.Api.Migrations
{
    ...
    [Migration("20260803045817_AddProjectedSOS")]
    partial class AddProjectedSOS
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaturdayPulse.Models.ProjectedRanking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("ProjectedLosses")
                        .HasColumnType("INTEGER");

                    b.Property<decimal?>("ProjectedPowerRating")
                        .HasColumnType("TEXT");

                    b.Property<decimal?>("ProjectedSOS")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TeamId", "Year", "Week")
                        .IsUnique()
                        .HasDatabaseName("UQ_ProjectedRanking_TeamId_Year_Week");

                    b.ToTable("ProjectedRankings");
                });
